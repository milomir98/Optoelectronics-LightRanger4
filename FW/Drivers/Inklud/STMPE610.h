...
// Calibration values  kalibracione vrednosti za stelovanje tac skrina
#define GUI_TOUCH_AD_TOP 270
#define GUI_TOUCH_AD_BOTTOM 3843
#define GUI_TOUCH_AD_LEFT 146
#define GUI_TOUCH_AD_RIGHT 3956
